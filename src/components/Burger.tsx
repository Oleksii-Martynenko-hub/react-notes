...
const BurgerMenuStyled = styled.div<{ isActive: boolean }>`
  ...
  transform: ${({ isActive }) => (isActive ? 'translate(0px, 0px) rotate(90deg)' : 'translate(0px, 0px) rotate(0deg)')};
  transition: ${({ isActive }) =>
    isActive ? 'transform 0.2s 0.0s, top 0.2s 0.2s' : 'transform 0.2s 0.2s, top 0.2s 0.0s'};
  ${SpanStyled} {
    &:nth-child(1),
    &:nth-child(3) {
      ...
      transition: ${({ isActive }) =>
        isActive ? 'transform 0.2s 0.2s, top 0.2s 0.0s' : 'transform 0.2s 0.0s, top 0.2s 0.2s'};
    }
    &:nth-child(3) {
      top: ${({ isActive }) => (isActive ? '-15px' : '0px')};
      transform: ${({ isActive }) => (isActive ? 'rotate(-45deg)' : 'rotate(0deg)')};
